...
@ComponentScan
public class Ch13R2DBCTacocloudRestclientApplication {

	public static void main(String[] args) {
		SpringApplication.run(Ch13R2DBCTacocloudRestclientApplication.class, args);
	}
			...
			tacoCloudClient.getIngredientBySlug("LETC")
					.flatMap(current -> {
						...
						Ingredient updated = new Ingredient(
								current.getId(),  // Сохраняем оригинальный ID
								"LETC",
